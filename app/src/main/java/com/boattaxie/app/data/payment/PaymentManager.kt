...
class PaymentManager @Inject constructor(
    ...
    suspend fun createAdCheckoutSession(
        ...
        location: String?,
        userId: String = "",
        existingAdId: String? = null  // Pass existing ad ID to activate a draft
    ): Boolean = withContext(Dispatchers.IO) {
        Log.d(TAG, "createAdCheckoutSession: durationDays=$durationDays, isFeatured=$isFeatured, businessName=$businessName, existingAdId=$existingAdId")
        ...
        try {
            ...
            val jsonBody = JSONObject().apply {
                ...
                put("userId", userId)
                put("existingAdId", existingAdId ?: JSONObject.NULL)
            }.toString()
