            ...
            result.fold(
                onSuccess = {
                    ...
                    _uiState.update { 
                        it.copy(
                            isLoading = false,
                            verificationStatus = VerificationStatus.PENDING, // Awaiting admin approval
                            successMessage = "Verification submitted! Awaiting admin approval. You'll be notified when approved.",
