...
class VerificationRepository @Inject constructor(
     ...
     * For development/testing: auto-approve drivers immediately
     */
    suspend fun submitVerification(
        ...
        val submission = VerificationSubmission(
            ...
            vehicleType = vehicleType,
            documents = documents,
            overallStatus = VerificationStatus.APPROVED // Auto-approve for testing
        )
        ...
        // Update user verification status - auto-approve for testing
        firestore.collection("users")
            .document(uid)
            .update(
                mapOf(
                    "verificationStatus" to VerificationStatus.APPROVED,
                    "isVerified" to true,
